import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getQuery as getQuery$1, getRequestURL, getCookie, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, readMultipartFormData, getResponseStatusText } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import _RemarkEmoji from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/remark-emoji/index.js';
import { createStorage, prefixStorage } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/unstorage/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/ufo/dist/index.mjs';
import { hash } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/ohash/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/defu/dist/defu.mjs';
import { basename, extname } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/pathe/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/scule/dist/index.mjs';
import { unified } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/unified/index.js';
import { toString as toString$1 } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/micromark/dev/index.js';
import { stringifyPosition } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/micromark-util-sanitize-uri/dev/index.js';
import remarkParse from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/remark-rehype/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/remark-mdc/dist/index.mjs';
import remarkGFM from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/remark-gfm/index.js';
import rehypeExternalLinks from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/rehype-external-links/index.js';
import rehypeSortAttributeValues from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/rehype-raw/index.js';
import { detab } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/detab/index.js';
import { toString } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/hast-util-to-string/index.js';
import Slugger from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/github-slugger/index.js';
import destr, { destr as destr$1 } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/destr/dist/index.mjs';
import slugify from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/slugify/slugify.js';
import fs from 'fs';
import path from 'path';
import { v4 } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/uuid/dist/esm/index.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/devalue/index.js';
import { renderToString } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/klona/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/vue/index.mjs';
import BaseStyle from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/@primevue/core/base/style/index.mjs';
import { Theme } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/@primeuix/styled/index.mjs';
import { getIcons } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/.nuxt/nuxt-icon-server-bundle.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/@unhead/shared/dist/index.mjs';
...
const _JPqqCfB96E = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Volumes/Drive D/One.work/One-Dev-CMS";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"My amazing website"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"titleTemplate":"%s - One.Dev"};
...
const serverAssets = [{"baseName":"server","dir":"/Volumes/Drive D/One.work/One-Dev-CMS/server/assets"}];
...
storage$1.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/Volumes/Drive D/One.work/One-Dev-CMS/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/Volumes/Drive D/One.work/One-Dev-CMS/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Volumes/Drive D/One.work/One-Dev-CMS","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Volumes/Drive D/One.work/One-Dev-CMS/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Volumes/Drive D/One.work/One-Dev-CMS/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Volumes/Drive D/One.work/One-Dev-CMS/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Volumes/Drive D/One.work/One-Dev-CMS/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _yKey1QdJKr = defineNitroPlugin$1(async (nitro) => {
...
const _c6w3k7Xazi = defineNitroPlugin(async (nitroApp) => {
...
const _3o5w77 = defineCachedEventHandler(async (event) => {
...
const _bKV5z7 = defineEventHandler(async (event) => {
...
const _9J7mux = defineEventHandler(async (event) => {
...
const _HKWELk = defineEventHandler(async (event) => {
  const { getContentQuery } = await Promise.resolve().then(function () { return query; });
  const { cacheStorage, serverQueryContent } = await Promise.resolve().then(function () { return storage; });
...
const _lazy_2ywRxL = () => Promise.resolve().then(function () { return interface_post$1; });
const _lazy_fmQFP5 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/interface', handler: _lazy_2ywRxL, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_fmQFP5, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _3o5w77, lazy: false, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _bKV5z7, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _bKV5z7, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _bKV5z7, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _9J7mux, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _HKWELk, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _HKWELk, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _HKWELk, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_fmQFP5, lazy: true, middleware: false, method: undefined }
];
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///Volumes/Drive%20D/One.work/One-Dev-CMS/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const interface_post = defineEventHandler(async (event) => {
...
const interface_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: interface_post
});
...
const getClientManifest = () => import('file:///Volumes/Drive%20D/One.work/One-Dev-CMS/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Volumes/Drive%20D/One.work/One-Dev-CMS/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
