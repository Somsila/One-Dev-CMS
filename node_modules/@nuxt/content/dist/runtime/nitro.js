...
export function queryCollectionNavigationWithEvent(event, collection, fields) {
  return chainablePromise(event, collection, (qb) => generateNavigationTree(qb, fields));
}
export function queryCollectionItemSurroundingsWithEvent(event, collection, path, opts) {
  return chainablePromise(event, collection, (qb) => generateItemSurround(qb, path, opts));
}
export async function queryCollectionSearchSections(event, collection, opts) {
