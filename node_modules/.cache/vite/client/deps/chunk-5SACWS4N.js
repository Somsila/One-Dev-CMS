...
import { openBlock as openBlock2, createElementBlock as createElementBlock2, mergeProps as mergeProps3, renderSlot, createTextVNode, toDisplayString } from "vue";
var script$1 = {
  name: "BaseBadge",
  "extends": script,
  props: {
...
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock2(), createElementBlock2("span", mergeProps3({
    "class": _ctx.cx("root")
...
import { mergeProps as mergeProps5, resolveComponent, resolveDirective, withDirectives, openBlock as openBlock3, createBlock, resolveDynamicComponent, withCtx, renderSlot as renderSlot2, createElementBlock as createElementBlock3, createCommentVNode, createElementVNode as createElementVNode2, toDisplayString as toDisplayString2, normalizeClass } from "vue";
...
function render3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return !_ctx.asChild ? withDirectives((openBlock3(), createBlock(resolveDynamicComponent(_ctx.as), mergeProps5({
    key: 0,
    "class": _ctx.cx("root")
  }, $options.attrs), {
    "default": withCtx(function() {
      return [renderSlot2(_ctx.$slots, "default", {}, function() {
        return [_ctx.loading ? renderSlot2(_ctx.$slots, "loadingicon", mergeProps5({
          key: 0,
          "class": [_ctx.cx("loadingIcon"), _ctx.cx("icon")]
        }, _ctx.ptm("loadingIcon")), function() {
          return [_ctx.loadingIcon ? (openBlock3(), createElementBlock3("span", mergeProps5({
            key: 0,
            "class": [_ctx.cx("loadingIcon"), _ctx.cx("icon"), _ctx.loadingIcon]
          }, _ctx.ptm("loadingIcon")), null, 16)) : (openBlock3(), createBlock(_component_SpinnerIcon, mergeProps5({
            key: 1,
            "class": [_ctx.cx("loadingIcon"), _ctx.cx("icon")],
            spin: ""
          }, _ctx.ptm("loadingIcon")), null, 16, ["class"]))];
        }) : renderSlot2(_ctx.$slots, "icon", mergeProps5({
          key: 1,
          "class": [_ctx.cx("icon")]
        }, _ctx.ptm("icon")), function() {
          return [_ctx.icon ? (openBlock3(), createElementBlock3("span", mergeProps5({
            key: 0,
            "class": [_ctx.cx("icon"), _ctx.icon, _ctx.iconClass]
          }, _ctx.ptm("icon")), null, 16)) : createCommentVNode("", true)];
        }), createElementVNode2("span", mergeProps5({
          "class": _ctx.cx("label")
...
//# sourceMappingURL=chunk-5SACWS4N.js.map
